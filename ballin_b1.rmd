...
```{r}
#A Function to Unnest and Factor a Variable in a Tibble
#Syntax suggested on StackOverflow by LyzandeR
#link: https://stackoverflow.com/questions/48062213/dplyr-using-column-names-as-function-arguments
unnest_and_factor <- function(x,y) { #where y is the variable to be un-nested and x is the dataset
    y <- enquo(y)
    x %>%
